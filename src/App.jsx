...
const INITIAL_CANDIDATES = [
  ...
  { id: 11, name: "Merle Vandervort",  date: "09 Sep, 2023", score: 4,   referred: false, stage: "interview", hasPhoto: true },
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
        ...
        <button
          ...
          style={{ background: "none", border: "none", color: "#94a3b8", cursor: "pointer", fontSize: 16, padding: "2px 4px", borderRadius: 4 }}
        >
          ···
        </button>
      </div>
      ...
      {/* Footer */}
      <div style={{ paddingTop: 10, borderTop: "0.5px solid #f1f5f9", display: "flex", alignItems: "center", justifyContent: "space-between", minHeight: 24 }}>
        {candidate.score !== null ? (
          <>
            <StarRating score={candidate.score} />
            {candidate.referred && (
              <span style={{ fontSize: 10, color: "#7c3aed", background: "#f5f3ff", padding: "2px 8px", borderRadius: 10, display: "flex", alignItems: "center", gap: 4 }}>
                👥 Referred
              </span>
            )}
          </>
  ...
  return (
    ...
    >
      <div style={{
        ...
        <button
          onClick={onClose}
          style={{ position: "absolute", top: 16, right: 16, background: "none", border: "none", fontSize: 18, color: "#94a3b8", cursor: "pointer" }}
        >
          ✕
        </button>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 18 }}>
          ...
          <div>
            <div style={{ fontSize: 16, fontWeight: 500, color: "#0f172a" }}>{candidate.name}</div>
...
function TopBar() {
  return (
    <div style={{ background: "#1a1f2e", display: "flex", alignItems: "center", gap: 20, padding: "0 20px", height: 52, flexShrink: 0 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <div style={{ width: 28, height: 28, background: "#f97316", borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, color: "#fff" }}>T</div>
        <span style={{ color: "#fff", fontWeight: 500, fontSize: 16 }}>tiimi</span>
        <span style={{ color: "rgba(255,255,255,0.3)", fontSize: 14, marginLeft: 8 }}>Recruitment</span>
      </div>
  ...
  return (
    <div style={{ background: "#fff", borderBottom: "0.5px solid #e2e8f0", padding: "14px 20px 0", flexShrink: 0 }}>
      <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: 10, marginBottom: 10 }}>
        <span style={{ fontSize: 20, fontWeight: 500, color: "#0f172a" }}>Research and Development Officer</span>
        <span style={{ background: "#dcfce7", color: "#15803d", fontSize: 11, padding: "2px 10px", borderRadius: 12, fontWeight: 500 }}>● Open</span>
        <span style={{ fontSize: 12, color: "#94a3b8" }}>Researcher · Onsite · Created by Bagus Fikri</span>
...
function Toolbar({ search, setSearch }) {
  return (
    <div style={{ background: "#fff", borderBottom: "0.5px solid #e2e8f0", display: "flex", alignItems: "center", flexWrap: "wrap", gap: 8, padding: "10px 20px", flexShrink: 0 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#f8fafc", border: "0.5px solid #e2e8f0", borderRadius: 8, padding: "6px 12px", width: 200 }}>
